...
export default function ChampionshipPage() {
  ...
  useEffect(() => {
    const fetchMatches = async () => {
      try {
        // Fetch Championship matches using dedicated API endpoint
        const timestamp = new Date().getTime();
        const response = await fetch(`/api/matches/championship?t=${timestamp}`, {
          cache: 'no-store',
          headers: {
        ...
        console.log('🟢 Championship API Response:', data);
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-6">
          ...
          <LeagueHeader
            ...
            logoPath="/assets/logos/leagues/efl_championship.svg"
            logoAlt="English Championship"
